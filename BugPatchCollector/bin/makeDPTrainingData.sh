...
for project_name in "jena" "camel" "groovy" "bval" "incubator-hivemall" "ace" "incubator-dolphinscheduler" "ant-ivy" "apex-core" "bigtop" "cayenne" "cordova-android" "creadur-rat" "crunch" "cxf-fediz" "deltaspike" "gora" "guacamole-client";
  do
