...
#for project_name in "jena";
  do
  ./BugPatchCollector -i https://github.com/apache/${project_name} -o ../../Output/LM -t -c ../../BIC/BIC_${project_name}.csv -s 0000-00-00 00:00:00 -e 2016-12-31 59:59:59 -d 1 -p ../../TrainData
done
