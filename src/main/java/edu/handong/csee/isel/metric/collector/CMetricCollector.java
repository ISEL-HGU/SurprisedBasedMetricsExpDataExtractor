...
// 		mergedArff = arffHelper.getMergedBOWArffBetween(bowCollector, cVectorCollector);
		...
		CommitCollector commitCollector = new CommitCollector(git, referencePath, bfcList, input.projectName, input.start_date, input.end_date, input.data_mode, input.training_data_path); //StartDate, strEndDate, test
